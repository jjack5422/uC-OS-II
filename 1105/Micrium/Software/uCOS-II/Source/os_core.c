                ...
                if (OSPrioHighRdy != OSPrioCur) {          /* No Ctx Sw if current task is highest rdy */
                    ...
                    if (OSTCBCur->CompletedFlag == 1) {
                        ...
                        if (OSTCBHighRdy->OSTCBPrio != 63) {
                            printf("%d\tCompletion\ttask(%2d)(%2d)\ttask(%2d)(%2d)\t%d\t%d\t%d\t\n", OSTimeGet(), cur->TaskID, cur->job_no, next->TaskID, next->job_no,cur->ResponseTime-1, cur->ResponseTime - cur->TaskExecutionTime-1,cur->Delay);
                            cur->job_no++;
                        }
                        else {
                            printf("%d\tCompletion\ttask(%2d)(%2d)\ttask(%2d)\t%d\t%d\t%d\n", OSTimeGet(), cur->TaskID, cur->job_no, OSTCBHighRdy->OSTCBPrio,cur->ResponseTime-1, cur->ResponseTime - cur->TaskExecutionTime-1,cur->Delay);
                            cur->job_no++;
                        }
            ...
            if (OSPrioHighRdy != OSPrioCur ) {          /* No Ctx Sw if current task is highest rdy     */
                ...
                if (OSTCBCur->CompletedFlag == 1) {
                    ...
                    if (OSTCBHighRdy->OSTCBPrio != 63) {
                        ...
                        printf("%d\tCompletion\ttask(%2d)(%2d)\ttask(%2d)\t%d\t%d\t%d\n", OSTimeGet(), cur->TaskID, cur->job_no, OSTCBHighRdy->OSTCBPrio,cur->ResponseTime, cur->ResponseTime - cur->TaskExecutionTime,cur->Delay);
                        cur->job_no++;
                    }
                    OSTCBCur->CompletedFlag = 0;
